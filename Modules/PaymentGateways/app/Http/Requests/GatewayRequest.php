...
namespace Modules\PaymentGateways\Http\Requests;
...
class GatewayRequest extends FormRequest
{
    ...
    * Get validation rules for Razorpay
    */
   private function sslcommerzRules(): array
   {
      return [
   ...
   /**
    * Get validation rules for Offline Payment
    */
   ...
   public function messages(): array
   {
      return [
         ...
         'payment_instructions.required' => 'The payment instructions field is required.',
         'payment_details.required' => 'The payment details field is required.',
      ];
   }
}
