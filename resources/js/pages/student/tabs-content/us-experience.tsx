...
const UsExperience = () => {
   ...
   return (
      <div className="space-y-4">
         ...
         <p className="text-muted-foreground text-sm">
            Download the PDF plans and blank Excel, fill the Quantity Summary, then submit your takeoff PDF and BOQ. Default
            tolerance is {payload.default_tolerance_percent ?? 2}% of each quantity. Pass a plan to unlock the next.
         </p>
