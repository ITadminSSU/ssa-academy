      ...
      <>
         ...
         <div className="space-y-6">
            <div className="flex items-center justify-between">
               <div>
                  <h1 className="text-3xl font-bold text-foreground">Exam Coupons</h1>
                  <p className="mt-1 text-sm text-muted-foreground">Manage discount coupons for your exams</p>
               </div>
               <CouponForm
                  title="Create Coupon"
                  exams={exams}
            ...
            <Card>
               <TableFilter data={coupons} title="Coupon List" globalSearch={true} tablePageSizes={[10, 15, 20, 25]} routeName="exam-coupons.index" />
