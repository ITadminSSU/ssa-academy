...
import DashboardWelcomeCampaignsSettings from './partials/dashboard-welcome-campaigns-settings';
import SsuLandingSettings from './partials/ssu-landing-settings';

const Pages = ({ pages, ssuLandingPage, home, dashboardWelcomeCampaigns = [], appTimezone, translate }: PageSelectProps) => {
   ...
   return (
      <>
         ...
         <div className="mx-auto space-y-10 md:px-3">
            ...
            <DashboardWelcomeCampaignsSettings campaigns={dashboardWelcomeCampaigns} appTimezone={appTimezone} />
