...
use App\Http\Controllers\FraudTrainingTiplineController;
...
Route::post('fraud-training-tipline', [FraudTrainingTiplineController::class, 'store'])
    ...
    ->name('fraud-training-tipline.store');
Route::get('fraud-training-tipline/warnings/{report}', [FraudTrainingTiplineController::class, 'warning'])
    ->name('fraud-training-tipline.warning');
