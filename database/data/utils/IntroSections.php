   ...
   public static function getHome1Sections(): array
   {
      $sections = [
         ...
         [
            ...
            'description' => 'Your professional development is supported by SMARTSOURCING USA ACADEMY covering everything from technical subjects to essential abilities.',
            'flags' => [
               'title' => true,
               'sub_title' => true,
               'description' => true,
