...
return [
  ...
  'platform_tools_description' => 'Lightweight SSU Academy utilities for cache refresh and public file access. No vendor updates or legacy maintenance UI.',
  'platform_tools_operations' => 'System utilities',
  'platform_tools_operations_description' => 'Use these after changing branding, environment variables, or when uploaded files are not appearing.',
  'platform_tools_clear_cache' => 'Clear platform cache',
  'platform_tools_clear_cache_description' => 'Reloads config, routes, views, and application cache so the latest settings and code are used.',
  'platform_tools_clear_cache_confirm' => 'Clear platform cache now?',
  'platform_tools_storage_link' => 'Create storage symlink',
  'platform_tools_storage_link_description' => 'Links storage to public so uploaded logos, media, and documents are served correctly.',
  'platform_tools_storage_link_confirm' => 'Create the storage symlink now?',
  'platform_tools_note' => 'Tip: After clearing cache, hard refresh your browser (Ctrl + Shift + R) to see branding or UI changes.',
