...
return [
    ...
    */
    ...
    'launches_on' => 'Launches {date}',
    'available_on' => 'Available on {date}',
    'starts_in' => 'Starts in',
    'staff_preview' => 'Staff preview',
    'staff_preview_note' => 'Staff preview — learners cannot access this course until launch.',
    'notify_me_title' => 'Notify me when available',
    'notify_me_description' => 'Get an email as soon as enrollment opens for this course.',
    'notify_subscribed_title' => 'You are on the list',
    'notify_subscribed' => 'We will email you when this course launches.',
    'launch_notify_count' => '{count} waiting to be notified',
    'days_left' => '{count} days left',

    // Subscription billing
    'subscription_monthly_cancel' => 'Monthly · Cancel anytime',
    'subscription_monthly_label' => 'Monthly',
    'subscription_details_title' => 'Subscription details',
    'subscription_billed_monthly' => 'Billed monthly until you cancel.',
    'subscription_cancel_anytime' => 'Cancel anytime from Dashboard → My Subscriptions → Manage billing.',
    'subscription_access_until_period_end' => 'After canceling, access continues until the end of your current billing period.',
    'subscription_self_service_cancel' => 'You are responsible for canceling before your next billing date.',
    'subscription_refund_note' => 'Refunds follow our',
    'refund_policy' => 'Refund Policy',
    'subscription_cancel_title' => 'How to cancel your subscription',
    'subscription_cancel_step_1' => 'Open Dashboard → My Subscriptions.',
    'subscription_cancel_step_2' => 'Click Manage billing.',
    'subscription_cancel_step_3' => 'Cancel your subscription in the secure billing portal.',
    'subscription_cancel_self_service' => 'You must cancel yourself before your next billing date. We cannot cancel on your behalf by email or chat.',
    'subscription_enrollment_note' => 'Your payment method will be charged monthly until you cancel.',
