...
return [
    ...
    */
    ...
    'instructor_applications_hint' => 'Students who applied via Become Instructor. To add staff trainers directly, use User Management and set account type to Trainer.',
    'review_application' => 'Review Application',
    'review_application_for' => 'Reviewing application for',
    'feedback_optional_approval' => 'Optional when approving. Required when rejecting.',
    ...
    'account_type_operations' => 'Operations Admin',
    'account_type_employee' => 'Internal employee (student access, free courses)',
    'account_type_trainer' => 'Trainer (instructor access)',
    'account_type_external' => 'External learner (student access, may pay)',
    'account_type_admin_description' => 'Full platform access including Settings',
    'account_type_operations_description' => 'Dashboard access without platform Settings',
    ...
    'account_type_external_description' => 'Public learner access; they may need to pay for courses',
    'account_type_edit_help' => 'Only full admins can change account type. You cannot change your own account type.',
    'admin_access_level' => 'Admin access',
    'admin_access_full' => 'Full admin (includes platform Settings)',
    'admin_access_operations' => 'Operations admin (no platform Settings)',
    'operations_admin_badge' => 'Operations admin',
