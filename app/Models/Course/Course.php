...
class Course extends Model implements HasMedia
{
    ...
    protected $casts = [
        ...
        'launch_offer_starts_at' => 'datetime',
        'launch_offer_ends_at' => 'datetime',
        'launch_list_price' => 'decimal:2',
        'launch_offer_price' => 'decimal:2',
        'launch_deposit_amount' => 'decimal:2',
        'launch_balance_amount' => 'decimal:2',
        'launch_subscription_trial_ends_at' => 'datetime',
        'launch_full_upfront_price' => 'decimal:2',
        'catalog_coupon_promo' => 'boolean',
        'catalog_coupon_off_remaining' => 'decimal:2',
        'launch_at' => 'datetime',
