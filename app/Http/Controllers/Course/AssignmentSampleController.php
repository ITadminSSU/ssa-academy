...
class AssignmentSampleController extends Controller
{
    public function __construct(
        private CourseCompletionGateService $gateService,
    ...
    public function download(CourseAssignment $assignment)
    {
        ...
        if ($assignment->sample_project_type === 'file') {
            if ($this->protectedMedia->resolveMediaForStreaming($assignment->sample_project_path)) {
                return $this->protectedMedia->streamStoredFileDownload(
